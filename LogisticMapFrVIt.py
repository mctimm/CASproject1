...
while not len(line) == 0:
    france.append(int(line.split()[0]))
...
HofFirstN = entropy(frit_pdf)
HofLastN = entropy(frit_pdf)
print(entropy(frit_pdf))
...
Xentropies = [HofFirstN[0]] #[HofFirstN[0], HofFirstN[2], HofLastN[0], HofLastN[2]]  
Yentropies = [HofFirstN[1]] #[HofFirstN[1], HofFirstN[3], HofLastN[1], HofLastN[3]]
mutualInfo = [0.5183] * 10
titles=['France vs Italy 7 - day average']
